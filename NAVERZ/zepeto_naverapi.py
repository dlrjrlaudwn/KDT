...
#     result_df_blog=pd.DataFrame(json_result_list_blog)
    ...
    result_df_news.to_csv('zepeto.csv',index=False,encoding='utf-8')
...
#워드 클라우드
total=open('zepeto.csv', encoding='utf-8').read()
okt=Okt()
...
tag_dict=dict(tags)
stopwords=['제페토','ZEPETO','등','플랫폼','메타','버스','산업','의','및','이번','이','있다','과','발표','생','수','것','위','은','글로벌','수출','한국','증가','팀','대한','있는','통해','를','있습니다',
